...
import delistIcon from "../../assets/icons/delist.svg";
                          ...
                          <TableBody>
                            <>
                              {menuClassData?.items?.map((item, index) => {
                                const delisted = item?.delisted === true;
                                return (
                                  <TableRow
                                    hover
                                    key={index}
          ...
          <Popover
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            {(editData?.status === 1 || editData?.delisted === false) &&  (
                                              <MenuItem
                                                onClick={() => {
                                            ...
                                            {(editData?.status === 0 || editData?.delisted === true) && (
                                              <MenuItem
                                                onClick={() => {
